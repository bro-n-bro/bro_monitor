<template>
    ...
    <!-- Network blocks -->
    <NetworkBlocks v-if="activeType == 1" />


    <!-- Network charts -->
    <NetworkCharts v-if="activeType == 2" />


    <!-- Network parameters -->
    <NetworkParameters v-if="activeType == 3" />
    </template>
</template>
