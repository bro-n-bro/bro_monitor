...
<script setup>
    ...
    onBeforeMount(() => {
        ...
        try {
            ...
            // Request
            fetch(`https://rpc.bronbro.io//statistics/validators/${props.validator.operator_address}/voting_power?from_date=${from_date}&to_date=${to_date}&detailing=${detailing}`)
                .then(res => res.json())
                .then(response => {
