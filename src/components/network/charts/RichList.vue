<template>
     <div class="block full_w" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.richList'], locked : store.isLocked() }" @mouseover="emitter.emit('setNotification', $t('message.notice_rich_list'))">
        <div class="btns">
