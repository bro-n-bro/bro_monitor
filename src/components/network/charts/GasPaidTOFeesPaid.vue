<template>
     <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.gasPaidTOFeesPaid'], locked : store.isLocked() }" @mouseover="emitter.emit('setNotification', $t('message.notice_gas_paid_to_fees_paid'))">
        <div class="btns">
