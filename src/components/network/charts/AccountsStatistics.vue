...
<script setup>
        ...
        series = reactive([
            {
                name: 'Users',
                group: 'group1',
                data: computed(() => chartDataUsers.value.slice(0, 6))
            },
            {
                name: 'New Users',
                group: 'group1',
                data: computed(() => chartDataNew.value.slice(0, 6))
            },
            {
                name: 'Active Users',
                group: 'group2',
                data: computed(() => chartDataActive.value.slice(0, 6))
            },
            {
                name: 'Inactive Users',
                group: 'group2',
                data: computed(() => chartDataInactive.value.slice(0, 6))
            },
        ]),
        chartOptions = reactive({
            ...
            tooltip: {
                ...
                custom: function({ dataPointIndex, w }) {
                    let left = w.globals.seriesXvalues[0][dataPointIndex] + 4,
    ...
    function initChart() {
        ...
        // Set labels
        store.cache.charts.active_accounts.slice(0, 6).forEach(el => {
