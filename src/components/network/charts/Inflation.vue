...
<script setup>
                ...
                custom: function({ dataPointIndex, w }) {
                    let left = w.globals.seriesXvalues[0][dataPointIndex] + w.globals.translateX,
                        ...
                        html = '<div class="chart_tooltip" style="'+ `left: ${left}px; top: ${top}px;` +'">' +
                                    ...
                                    '<div class="tooltip_val">' + i18n.global.t('message.network_charts_inflation_title') + ': ' + (store.cache.inflation[dataPointIndex].y * 100).toFixed(2) + '%</div>' +
                                '</div>'
    ...
    function initChart() {
        ...
        // Set labels
        store.cache.inflation.forEach(el => {
