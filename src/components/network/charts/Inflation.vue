<template>
    <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.inflation'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_inflation', { token: store.networks[store.currentNetwork].token_name }))">
        <div class="btns">
