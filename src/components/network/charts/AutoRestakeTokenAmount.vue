<template>
     <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.autoRestakeTokenAmount'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_auto_restake_token_amount'))">
        <div class="btns">
...
<script setup>
    ...
    function initChart() {
        ...
        // Set labels
        store.cache.charts.restake_token_amount.forEach(el => {
