<template>
     <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.autoRestakeTokenAmount'] }">
        <div class="btns">
            <button class="pin_btn btn" @click.prevent="emitter.emit('togglePinBlock', 'cosmoshub.charts.autoRestakeTokenAmount')">
        ...
        <div class="title">
            {{ $t('message.network_charts_auto_restake_token_amount_title') }}
        </div>
...
<script setup>
    ...
    function initChart() {
        ...
        // Set labels
        store.cache.restake_token_amount.forEach(el => {
