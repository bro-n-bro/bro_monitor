<template>
     <div class="block full_w" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.TOPTransactions'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_TOP_transactions'))">
        <div class="btns">
