<template>
     <div class="block full_w" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.validatorGroupMap'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_validator_group_map_voting_power_commission'))">
        <div class="btns">
