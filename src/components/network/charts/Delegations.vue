<template>
     <div class="block full_w" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.delegations'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_delegations'))">
        <div class="btns">
