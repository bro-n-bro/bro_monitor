<template>
    <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.charts.APY'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_APY'))">
        <div class="btns">
...
<script setup>
                ...
                custom: function({ dataPointIndex, w }) {
                    let left = w.globals.seriesXvalues[0][dataPointIndex] + w.globals.translateX,
                        ...
                        html = '<div class="chart_tooltip" style="'+ `left: ${left}px; top: ${top}px;` +'">' +
                                    ...
                                    '<div class="tooltip_val">' + i18n.global.t('message.network_charts_APY_title') + ': ' + (store.cache.charts.apy[dataPointIndex].y * 100).toFixed(2) + '%</div>' +
                                '</div>'
    ...
    function initChart() {
        ...
        // Set labels
        store.cache.charts.apy.forEach(el => {
