<template>
    <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.blocks.bondedRatio'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_bonded_ratio', { token: store.networks[store.currentNetwork].token_name }))">
        <div class="btns">
