<template>
    <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.blocks.bondedTokens'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_bonded_tokens', { token: store.networks[store.currentNetwork].token_name }))">
        <div class="btns">
