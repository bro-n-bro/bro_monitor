<template>
    <div class="block" :class="{ pinned: store.pinnedBlocks['cosmoshub.blocks.inactiveAccounts'] }" @mouseover="emitter.emit('setNotification', $t('message.notice_inactive_accounts'))">
        <div class="btns">
